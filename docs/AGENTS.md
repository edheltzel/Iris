...
- Conversion/handoff scope, spec, and plan are owned by `docs/iris-vision.md` (full FM-553 living SoT). `docs/exceed-inventory.md` is the FM-554 companion inventory (provenance only). `docs/vision.md` remains public product positioning until a later identity/rename ship.
